...
export function Navbar() {
	...
	const mainMenuItems = useMemo(
		() => [
			...
			// { path: "/shuffle-monthly", name: "Shuffle Monthly", icon: <CalendarRange className='w-5 h-5' /> },
		...
		() =>
			user?.role === "admin"
				? [
					...
					// { path: "/shuffle-monthly/admin", name: "Shuffle Admin", icon: <CalendarRange className='w-5 h-5' /> },
