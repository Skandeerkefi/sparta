...
| Slot call x1600 hit | `+500` | Awarded when a played slot call is marked as a 1600x hit. |
...
- Performance rewards: giveaway wins, accepted slot calls, x1600 hits, match wins, tournament wins.
